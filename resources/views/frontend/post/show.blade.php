...
>
    <div class="container mx-auto px-6 relative">
        <div class="mb-8">
            <a
                wire:navigate
                class="inline-flex items-center text-slate-500 hover:text-slate-900 transition-colors text-sm font-medium"
                href="{{ route('news') }}"
                data-discover="true"
            >
        ...
        <div class="max-w-4xl mx-auto">
            <header class="mb-10 text-center md:text-left border-b border-slate-200 pb-4">
                <h1 class="text-3xl md:text-5xl font-bold text-slate-900 mb-6 leading-tight">{{ $post->title }}</h1>
            </header>

            <div class="mb-12 rounded-2xl overflow-hidden border border-slate-200 shadow-xl bg-slate-100 aspect-video md:aspect-[21/9] relative">
                ...
                <div class="prose prose-lg max-w-none text-slate-600 mb-16 prose-headings:text-slate-900 prose-a:text-[#036482] prose-strong:text-slate-900 prose-li:marker:text-[#036482]">
                    {!! $post->content !!}
                </div>
            <div class="border-t border-slate-200 pt-10 pb-20 flex flex-col md:flex-row justify-between items-center gap-6">
                <div class="text-slate-500 font-medium">Share this article</div>
                <div class="flex gap-4">
                    <button class="w-10 h-10 rounded-full bg-white border border-slate-200 flex items-center justify-center text-slate-500 hover:bg-[#036482] hover:text-white hover:border-[#036482] transition-all shadow-sm">
