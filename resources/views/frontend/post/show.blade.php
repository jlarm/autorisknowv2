...
{{--            <div--}}
{{--                class="border-t border-white/10 pt-10 pb-20 flex flex-col md:flex-row justify-between items-center gap-6">--}}
{{--                <div class="text-slate-400 font-medium">Share this article</div>--}}
{{--                <div class="flex gap-4"><button--}}
{{--                        class="w-10 h-10 rounded-full bg-[#1e293b] border border-white/10 flex items-center justify-center text-slate-300 hover:bg-cyan-600 hover:text-white hover:border-cyan-500 transition-all"><svg--}}
{{--                            xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"--}}
{{--                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"--}}
{{--                            stroke-linejoin="round" class="lucide lucide-linkedin w-4 h-4" aria-hidden="true">--}}
...
{{--                            xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"--}}
{{--                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"--}}
{{--                            stroke-linejoin="round" class="lucide lucide-twitter w-4 h-4" aria-hidden="true">--}}
{{--                            <path--}}
...
{{--                            xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"--}}
{{--                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"--}}
{{--                            stroke-linejoin="round" class="lucide lucide-facebook w-4 h-4" aria-hidden="true">--}}
{{--                            <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"></path>--}}
{{--                        </svg></button><button--}}
{{--                        class="w-10 h-10 rounded-full bg-[#1e293b] border border-white/10 flex items-center justify-center text-slate-300 hover:bg-cyan-600 hover:text-white hover:border-cyan-500 transition-all"><svg--}}
{{--                            xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"--}}
{{--                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"--}}
{{--                            stroke-linejoin="round" class="lucide lucide-share2 lucide-share-2 w-4 h-4"--}}
{{--                            aria-hidden="true">--}}
