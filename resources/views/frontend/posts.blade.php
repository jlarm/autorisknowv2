<x-layouts.frontend
    title="Industry News & Regulatory Updates - Automotive Compliance Standards | ARMP"
...
>
    <div class="container mx-auto px-6 space-y-24">
        <section class="max-w-4xl mx-auto text-center pt-12 space-y-8">
            ...
            <p class="text-xl text-slate-400 leadCan you ing-relaxed mb-8">Stay informed on the latest regulations and standards affecting the automotive industry</p>
        </section>
