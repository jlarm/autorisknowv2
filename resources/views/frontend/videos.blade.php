<x-layouts.frontend
    title="Training Videos & Resources - Dealership Compliance Education | ARMP"
  ...
  dealership stay compliant."
    ogImage="{{ asset('video-library.webp') }}"
    twitterTitle="ARMP Training Videos - Dealership Compliance Education"
