    ...
    <header
        ...
        <div class="container mx-auto px-6 flex items-center justify-between">
            ...
            <nav class="hidden lg:flex items-center gap-8">
                ...
                <a wire:navigate href="{{ route('solutions') }}"
                    class="{{ request()->routeIs('solutions') ? 'text-[#EC7700]' : 'text-slate-400' }} text-sm font-medium hover:text-[#EC7700] transition-all duration-300 relative group px-1 py-1 ">Solutions</a>
